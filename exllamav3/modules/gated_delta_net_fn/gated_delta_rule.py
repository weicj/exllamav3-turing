...
# Keep a correctness escape hatch for long-prefill state investigations. The CUDA recurrent
# implementation follows the same contract, albeit with lower prefill throughput.
if os.environ.get("EXL3_DISABLE_FLA_GDN", "0") == "1":
    chunk_gated_delta_rule = None
